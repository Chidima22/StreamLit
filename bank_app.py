...
with col1:
    # Display the first 5 input features
...
with col2:
    # Display the last 5 input features
    gender_of_respondent =  gender_of_respondent_encoder[st.selectbox("Gender_of_respondent", df["gender_of_respondent"].unique())]
...
if predict_button:
    ...
    if prediction[0] == "Yes":
        ...
        st.error("The customer is likely not have a bank account.")
